...
1. **Current prototype (V1)** â€” the components actually used and tested in the
   current ESP32-WROOM-32 build.
2. **Planned (V2)** â€” the target bill of materials (from `BOM.csv`). These are
...
See [../architecture/HARDWARE.md](../architecture/HARDWARE.md) for interface details and
[../testing/WIRING.md](../testing/WIRING.md) for the verified pinout.
...
| 3 | Display | 5.0" IPS Capacitive Touch Display | 800Ã—480 | 1 | 4499 | Waveshare | Primary user interface |
...
| 6 | Audio | Premium Full-Range Speaker | FRS7 4 Î© 10 W | 1 | 950 | Mouser | Voice output |
...
> them (see [../architecture/HARDWARE.md](../architecture/HARDWARE.md) â†’ "Planned (V2)").
