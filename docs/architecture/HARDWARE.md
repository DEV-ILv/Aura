...
1. **Current prototype (V1, MK-II)** â€” the hardware actually supported and
   tested by the current firmware build (ESP32-WROOM-32).
2. **Planned (V2)** â€” the next-generation hardware bill of materials
   (ESP32-P4 + ESP32-CAM) as listed in `BOM.csv`. None of the V2 components
   have firmware support in the current build.

Wiring and pinout live in [../testing/WIRING.md](../testing/WIRING.md); the full parts list lives in
[../development/PARTS.md](../development/PARTS.md).
...
[../testing/WIRING.md](../testing/WIRING.md); the parts list lives in [../development/PARTS.md](../development/PARTS.md).

| Component | Function | Interface | Status |
| --- | --- | --- | --- |
| ESP32-WROOM-32 (38-pin) | Main MCU (Wi-Fi + BLE) | on-board | Ready |
| SSD1306 OLED, 128Ã—64 | Display (face, clock, states) | I2C (`0x3C`) | Ready |
...
> `AURA_HW_SPEAKER_PRESENT = 0` (see the Instruction Manual Â§3). The I2S
...
The firmware can run on a **bare ESP32-WROOM-32 with only a USB cable** â€” no
...
hardware is present). See `README.md` â†’ "Headless development mode".
...
sensors (BME280, BH1750, BMI270, VL53L0X), GPS, RTC, NFC, and battery power â€”
...
- **ESP32-WROOM-32** â€” current/prototype hardware used for testing (concept
  proven; see "Current prototype (V1)" above).
- **ESP32-CAM** â€” planned camera-capable hardware (not yet purchased/tested).

See [../development/PARTS.md](../development/PARTS.md) for the full parts list and [../testing/WIRING.md](../testing/WIRING.md)
