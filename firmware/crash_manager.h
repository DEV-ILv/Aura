...
public:
    ...
    /**
     * @brief Check if last restart was a recovery/health reboot
     * @return true if rst_reason starts with "health_reboot_"
     */
    [[nodiscard]] bool wasRecoveryRestart() noexcept;
