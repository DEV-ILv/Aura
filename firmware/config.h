...
#define SARVAM_STT_MODEL         "saaras:v3"
#define SARVAM_TTS_MODEL         "bulbul:v3"
...
// Default TTS speaker (Sarvam provides a set of named voices: shubh, aditya,
// ritu, priya, ...). Overridable at runtime via setVoice().
#define SARVAM_VOICE             "shubh"
...
//======================================================
// HEALTH & SELF-RECOVERY (HealthManager)
//======================================================

// Bounded recovery: max recovery attempts per subsystem before it is marked
// FAILED, and the cooldown between attempts. After FAILED the subsystem keeps
// operating in degraded mode; the device is rebooted only as a last resort.
#define AURA_HEALTH_MAX_ATTEMPTS        3
#define AURA_HEALTH_COOLDOWN_MS         30000UL
#define AURA_HEALTH_FAILED_TO_REBOOT_MS 180000UL  // sustain FAILED this long before reboot
#define AURA_HEALTH_REBOOT_COOLDOWN_MS  600000UL  // min time between last-resort reboots
#define AURA_HEALTH_MIN_UPTIME_MS       120000UL  // never reboot within 2 min of boot
#define AURA_HEALTH_REBOOT_ENABLED      1         // 1 = allow last-resort reboot
...
#define CRASH_RESTART_REASON_KEY "rst_reason"
